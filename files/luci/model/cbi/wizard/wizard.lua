...
e = s:taboption("wansetup", Value, "lan_gateway", translate("IPv4 gateway"))
e:depends({wan_proto="siderouter"})
e.placeholder = "Please enter the primary route IP"
e.datatype = "ip4addr"

e = s:taboption("wansetup", DynamicList, "lan_dns", translate("Use custom DNS servers"))
e:depends({wan_proto="siderouter"})
...
e = s:taboption("lansetup", Flag, "ipv6",translate('Enable IPv6'), translate('Enable/Disable IPv6'))
